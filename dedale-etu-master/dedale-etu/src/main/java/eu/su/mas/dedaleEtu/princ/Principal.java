...
public class Principal {
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		ag = createNewDedaleAgent(c, agentName, AgentAdaptatif.class.getName(), entityParametersExplo1);// ExploreSoloAgent
		agentList.add(ag);
		...
		// 4) Give the class name of your agent to let the system instantiate it
		ag = createNewDedaleAgent(c, agentName, AgentAdaptatif.class.getName(), entityParametersExplo2);// ExploreSoloAgent
		agentList.add(ag);
		...
		// //4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentEvolutif.class.getName(),entityParametersExplo3);//ExploreSoloAgent
		agentList.add(ag);
		...
		//
		// //4) Give the class name of your agent to let the system instantiate it
		// ag=createNewDedaleAgent(c, agentName, DummyTankerAgent.class.getName(),
		// entityParametersT);
		// agentList.add(ag);
		//
